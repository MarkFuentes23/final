                                ...
                                ?>
                                        <tr class="<?php echo $row_class; ?>"> <!-- Add row_class to the table row -->
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-info btn-flat view_order" data-bs-toggle="modal" data-bs-target="#viewOrderModal" data-id="<?php echo $row['ID']; ?>" <?php echo $disabled ? '' : ''; ?>>
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <a href="update_reservation.php?updateID=<?php echo $ID; ?>" class="btn btn-success btn-sm <?php echo $disabled ? 'disabled' : ''; ?>">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <a href="delete-reservation.php?deleteID=<?php echo $ID; ?>" class="btn btn-danger btn-sm <?php echo $disabled ? 'disabled' : ''; ?>">
