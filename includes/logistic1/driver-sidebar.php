...
<div class="sb-sidenav-menu">
    <div class="nav">
        ...
        <a class="nav-link" href="/sub-modules/logistic1/vehicle-reservation/driver-only.php" style="font-family: 'Rokkitt', sans-serif; color: black;">
            <div class="sb-nav-link-icon" style="color: #3CB371;"><i class="fas fa-search"></i></div>
            Upcoming Delivery
        </a>
          <a class="nav-link" href="/sub-modules/logistic1/vehicle-reservation/waze.php" style="font-family: 'Rokkitt', sans-serif; color: black;">
            <div class="sb-nav-link-icon" style="color: #3CB371;"><i class="fas fa-map"></i></div>
            Waze 
        </a>
        ...
        <a class="nav-link" href="/sub-modules/logistic1/vehicle-reservation/driver-completed.php" style="font-family: 'Rokkitt', sans-serif; color: black;">
