...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!filter_var($new_email, FILTER_VALIDATE_EMAIL)) {
        ...
        if (isset($_FILES['profile_pic']) && $_FILES['profile_pic']['error'] == 0) {
            $target_dir = $_SERVER['DOCUMENT_ROOT'] . "/includes/logistic2/admin/profile/uploads/";
            ...
            if ($check !== false && in_array($imageFileType, $allowed_types)) {
                if ($_FILES['profile_pic']['size'] > 5000000) {
                    ...
                    $profile_pic_path = "/includes/logistic2/admin/profile/uploads/" . $filename;
    ...
    header("Location: /includes/logistic1/admin/profile/profile_setting.php");
    exit();
}
?>
            ...
            <main>
                <div class="container">
                    <div class="profile-card">
                        <h1>Edit Profile</h1>
                        <form action="/includes/logistic1/admin/profile/profile_setting.php" method="POST" enctype="multipart/form-data" onsubmit="return validatePassword();">
